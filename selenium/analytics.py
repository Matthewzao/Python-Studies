...
driver.get(" https://www.magazineluiza.com.br/informatica/l/in/")

nome = driver.find_element_by_xpath('//*[@id="__next"]/div[2]/div/div[1]/div/div[2]/nav/div/div/div/ul/li[2]/a')
nomeText = nome.text
